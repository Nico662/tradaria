                  ...
                  return (
                    <>
                      {top10.map((p, i) => {
                        ...
                        return (
                          <div key={String(p.userId?._id ?? i)} style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '10px 12px', background: isMe ? 'rgba(34,211,165,0.07)' : 'var(--bg-card)', border: `1px solid ${rankColor}`, borderLeft: isMe ? '2px solid rgba(34,211,165,0.6)' : '2px solid transparent', borderRadius: '8px', marginBottom: '8px', overflow: 'hidden', width: '100%' }}>
