...
export default function AcadiasLanding({ onEnter }) {
  ...
  return (
    <div style={{ background: 'var(--bg-page)', minHeight: '100vh', fontFamily: 'var(--font-body)', overflowX: 'hidden' }}>
      <style>{`
      ...
      <div className="aca-wrap" style={{ maxWidth: '680px', margin: '0 auto', padding: '0 24px' }}>
        ...
        <section style={{ textAlign: 'center', padding: '72px 0 64px', animation: 'acaUp 0.5s both' }}>
          ...
          <button onClick={goApp} className="aca-btn-primary"
            style={{ background: 'var(--green)', border: 'none', borderRadius: '8px', color: 'var(--bg-page)', fontFamily: 'var(--font-body)', fontWeight: 800, fontSize: '15px', cursor: 'pointer', padding: '16px 36px', boxShadow: '0 4px 20px rgba(0,229,160,0.25)', letterSpacing: '0.01em' }}>
            {a.heroCta} →
          </button>
        </section>
        ...
        {/* ── 7. FAQ ── */}
        <section className="aca-reveal" style={{ paddingBottom: '64px' }}>
          <div style={{ fontFamily: 'var(--font-body)', fontWeight: 800, fontSize: '20px', color: 'var(--t1)', textAlign: 'center', marginBottom: '24px', letterSpacing: '-0.01em' }}>{a.faqTitle}</div>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
            {FAQS.map((faq, i) => (
              <div key={i} className="aca-faq-row" style={{ background: 'var(--bg-card)', border: `1px solid ${openFaq === i ? 'rgba(0,229,160,0.25)' : 'var(--bd)'}`, borderRadius: '10px', overflow: 'hidden', transition: 'border-color 0.2s' }}>
                <button className="aca-faq-btn"
                  ...
                  <span style={{ fontFamily: 'var(--font-body)', fontWeight: 700, fontSize: '12px', lineHeight: 1.4 }}>{faq.q}</span>
        ...
        <section className="aca-reveal" style={{ paddingBottom: '80px' }}>
          <div style={{ background: 'var(--bg-card)', border: '1px solid rgba(0,229,160,0.2)', borderRadius: '16px', padding: '48px 28px', textAlign: 'center' }}>
            <div style={{ fontFamily: 'var(--font-body)', fontWeight: 800, fontSize: '22px', color: 'var(--t1)', marginBottom: '24px', lineHeight: 1.2, letterSpacing: '-0.01em' }}>
              {a.finalTitle}
            </div>
            <button onClick={goApp} className="aca-btn-primary"
              style={{ background: 'var(--green)', border: 'none', borderRadius: '8px', color: 'var(--bg-page)', fontFamily: 'var(--font-body)', fontWeight: 800, fontSize: '14px', cursor: 'pointer', padding: '16px 36px', boxShadow: '0 4px 20px rgba(0,229,160,0.25)', letterSpacing: '0.01em', marginBottom: '16px', display: 'block', width: '100%' }}>
              {a.finalCta}
            </button>
