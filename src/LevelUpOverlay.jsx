...
const PARTICLES = Array.from({ length: 28 }, (_, i) => ({
  ...
  size:  `${6 + (i * 3) % 8}px`,
  color: i % 3 === 0 ? '#f5c842' : i % 3 === 1 ? '#22d3a5' : '#ffffff',
  rot:   `${(i * 47) % 360}deg`,
}));
  ...
  return (
    <div onClick={onClose} style={{
      ...
      <style>{`
        ...
        @keyframes luGlow      { 0%,100% { text-shadow:0 0 20px rgba(245,200,66,.5) } 50% { text-shadow:0 0 40px rgba(245,200,66,.9), 0 0 80px rgba(245,200,66,.3) } }
      ...
      <div onClick={e => e.stopPropagation()} style={{
        ...
        width: '90%',
        position: 'relative',
        boxShadow: '0 0 60px rgba(245,200,66,0.15), 0 20px 60px rgba(0,0,0,0.8)',
        ...
        <div style={{
          ...
          <span style={{ fontFamily: "'Space Mono', monospace", fontSize: '11px', color: '#f5c842', fontWeight: 700 }}>
