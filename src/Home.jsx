      ...
      <div style={{ padding: '16px 16px 24px', position: 'relative', zIndex: 2 }}>
        ...
        <div style={{ textAlign: 'center', marginTop: '32px', paddingBottom: '8px' }}>
          <div style={{ display: 'flex', justifyContent: 'center', gap: '16px', alignItems: 'center', flexWrap: 'wrap' }}>
            ...
            <a href="https://discord.gg/dsVU4yxsN" target="_blank" rel="noopener noreferrer"
              style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', color: '#5865F2', textDecoration: 'none', padding: '4px 8px', borderRadius: '6px', transition: 'opacity 0.15s' }}
