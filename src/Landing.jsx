...
function DemoChart() {
  ...
  return (
    <div style={{ background: 'var(--bg-surface)', border: '1px solid #1e2530', borderRadius: '12px', padding: '20px', marginBottom: '28px' }}>
      <div style={{ fontSize: '12px', color: '#3a4455', letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: '16px', fontFamily: 'var(--font-body)' }}>
        BTC/USDT · 1h
      </div>
        ...
        <div style={{ display: 'flex', gap: '8px' }}>
          {[
            ...
            <button key={btn.id} onClick={() => pick(btn.id)}
              style={{ flex: 1, padding: '8px 4px', background: btn.bg, border: `1px solid ${btn.color}`, borderRadius: '6px', color: btn.color, fontFamily: 'var(--font-body)', fontSize: '12px', fontWeight: 700, letterSpacing: '0.04em', cursor: 'pointer', transition: 'transform 0.15s' }}
      ...
      {choice && !revealed && (
        <div style={{ textAlign: 'center', fontSize: '12px', color: '#3a4455', fontFamily: 'var(--font-body)', letterSpacing: '0.08em', padding: '8px 0' }}>
          revealing...
        </div>
      )}
    ...
    <div style={{ background: 'var(--bg-base)', minHeight: '100vh', fontFamily: 'var(--font-body)', position: 'relative', overflowY: 'auto' }}>
      ...
      <div style={{ maxWidth: '420px', margin: '0 auto', padding: '56px 28px 120px' }}>
        ...
        <div className="landing-section landing-s4" style={{ textAlign: 'center', marginBottom: '36px' }}>
          <div style={{ fontSize: '12px', color: '#3a4455', letterSpacing: '0.08em' }}>
