  ...
  return (
    <div style={{ margin: '0 20px 12px' }}>
      <div style={{
        ...
        {/* Header */}
        <div style={{ fontSize: '7px', color: '#4a3a10', letterSpacing: '0.2em', textTransform: 'uppercase', marginBottom: '8px', fontFamily: 'var(--font-body)' }}>
          {weekLabel}
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '6px', marginBottom: '3px', paddingRight: '52px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '5px', flex: 1 }}>
            ...
            <span style={{ fontFamily: 'var(--font-body)', fontSize: '9px', fontWeight: 700, color: completed ? 'var(--green)' : '#e8d4a0', letterSpacing: '0.02em', lineHeight: 1.3 }}>
              {title}
            </span>
          </div>
          <span style={{ fontFamily: 'var(--font-body)', fontSize: '8px', fontWeight: 700, color: completed ? 'var(--green)' : 'var(--color-neutral)', flexShrink: 0 }}>
            +{mission.xp} XP
          </span>
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
          ...
          <span style={{ fontFamily: 'var(--font-body)', fontSize: '7px', color: '#5a4a20', flexShrink: 0 }}>
            {progress}/{mission.target}
          </span>
        </div>

        {/* Reset label */}
        <div style={{ marginTop: '5px', fontSize: '7px', color: '#3a2a10', fontFamily: 'var(--font-body)', letterSpacing: '0.06em' }}>
          {resetLabel}
        </div>
      </div>
    </div>
